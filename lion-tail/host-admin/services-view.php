...
if (isset($_GET['delete']) && !empty($_GET['delete'])) {
 $passportIn = $cal->selectFrmDB($services_tb, 'image', 'id', $_GET['delete']);
 if (query_sql("DELETE FROM $services_tb WHERE `id`='" . $_GET['delete'] . "' LIMIT 1")) {
  $bassic->unlinkFile($passportIn, '../../photo/');
  $msg = 'Delete process was successful!';
  header("location:services-view?done=" . $msg);
 } else {
    ...
    <div class="row">
     <div class="col-lg-12">
      ...
      <ol class="breadcrumb">
       ...
       <li><i class="fa fa-laptop"></i> Services View</li>
       <li><i class="fa fa-laptop"></i><a href="services"> Post Services</a></li>
      </ol>
     </div>
    </div>
