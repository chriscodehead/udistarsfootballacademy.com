...
if (isset($_POST['post'])) {
  ...
  if (!empty($name) && !empty($pic_name)) {
    ...
    if (query_sql("INSERT INTO $team_tb VALUES(null ,'" . $user_id . "' ,'" . $name . "','" . $category . "','" . $new_name . "','" . $position . "','" . $facebook . "','" . $twitter . "','" . $linkedin . "','" . $date_created . "','" . $bio . "')")) {
              ...
              <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                <tbody>
                  ...
                  <tr>
                    <td>
                      <label>Bio:</label>
                      <textarea class="form-control" value="" name="bio"></textarea>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <label>Position(eg: 10):</label>
                      <input class="form-control" placeholder="10" type="text" value="" name="position">
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <label>Profile Picture(508 X 339):</label>
                  ...
                  <tbody>
                    ...
                    ?>
                        <tr>
                          ...
                          <th title="<?php print $row['bio']; ?>" style="font-size: 10px;"><?php print $row['bio']; //$bassic->reduceTextLength($row['bio'], 20); 
                                                                                            ?></th>
                          <th><?php print $row['position']; ?></th>
                          <th style="display: none;"><?php print $row['facebook']; ?><br>
